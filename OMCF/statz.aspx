...
protected void onClickUser(object sender, EventArgs e)
{
    ...
    SqlDataSourceSearchResults.SelectParameters["idd"].DefaultValue = DropDownListRequestorID.SelectedValue;
            SqlDataSourceSearchResults.SelectParameters["B1"].DefaultValue = TextBox1.Text;
        SqlDataSourceSearchResults.SelectParameters["B2"].DefaultValue = TextBox2.Text;
}
...
SqlDataSourceSearchResults.SelectParameters["idd"].DefaultValue = "clear";
    SearchResultsRest.SelectParameters["idd"].DefaultValue = RestNum.SelectedValue;
        SearchResultsRest.SelectParameters["B1"].DefaultValue = TextBox1.Text;
        SearchResultsRest.SelectParameters["B2"].DefaultValue = TextBox2.Text;
}
...
<div id="cal">
 <asp:Calendar ID="Calendar2" runat="server" OnSelectionChanged="Calendar2_SelectionChanged"></asp:Calendar>
        ...
        SelectCommand="SELECT * FROM [PeriodChangeRequest] WHERE ([RequestedBy] = @idd AND dateInfo BETWEEN @B1 AND @B2) ORDER BY goLiveDate DESC">
   <SelectParameters>
...
<asp:Parameter Name="B2" Type="String" />
        ...
        SelectCommand="SELECT * FROM [PeriodChangeRequest] WHERE ([RestaurantNum] = @idd AND dateInfo BETWEEN @B1 AND @B2) ORDER BY goLiveDate DESC">
   <SelectParameters>
       <asp:Parameter Name="idd" Type="String" />
<asp:Parameter Name="B1" Type="String" />
<asp:Parameter Name="B2" Type="String" />
